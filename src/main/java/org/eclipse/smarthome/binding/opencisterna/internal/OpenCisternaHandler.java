...
import static org.eclipse.smarthome.binding.opencisterna.internal.OpenCisternaBindingConstants.*;
...
public class OpenCisternaHandler extends BaseThingHandler {
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        if (channelUID.getId().equals(FLUID_LEVEL)) {
            // TODO: handle command
        ...
        } else if (channelUID.getId().equals(FLUID_QUANTITY)) {
            // TODO: handle Command
        }
    }
